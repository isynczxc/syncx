...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'itsscandelaria@hotmail.com',
  ...
  googleFontSans: 'Yantramanav',
  // googleFontMono - the monospace font used in onedrive-cf-index-ng.
  googleFontMono: 'Fira Mono',
  // googleFontLinks -  an array of links for referencing the google font assets.
  googleFontLinks: ['https://fonts.googleapis.com/css2?family=Fira+Mono&family=Yantramanav:wght@500;600;800&display=swap'],
  ...
  protectedRoutes: ['/🚫大胆な', '/🔒Personal Vault'],
  hiddenFolders: ['🔒Personal Vault'],
